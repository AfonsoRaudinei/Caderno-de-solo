...
import 'package:soloforte/presentation/auth/cadastro/cadastro_controller.dart';
    ...
    ref.listen<AsyncValue<void>>(
      ...
      (_, state) {
        if (state.hasError) {
          ...
          // Sucesso - Cadastro em modo dev aprova e volta pro login
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
    ...
    void nextStep(int step, GlobalKey<FormState> formKey) {
      if (formKey.currentState!.validate()) {
        if (step == 1 && perfilNotifier.value == null) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Selecione seu perfil.'), backgroundColor: AppColors.error),
          );
          return;
        }
        if (step == 2 && estadoNotifier.value == null) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Selecione um estado.'), backgroundColor: AppColors.error),
          );
          return;
        }
          ...
          children: [
                  ...
                  return Expanded(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: index <= currentStep ? AppColors.primary : AppColors.borderSoft,
            ...
            Expanded(
              child: PageView(
                ...
                physics: const NeverScrollableScrollPhysics(), // Impede swipe manual
                children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          AppInput(
                            ...
                            validator: (v) => v!.isEmpty ? AppStrings.campoObrigatorio : null,
                          ),
                  ...
                  SingleChildScrollView(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.stretch,
                        children: [
                          Text('Onde você atua?', style: AppTextStyles.headline),
                          const SizedBox(height: 8),
                          Text(
                  ...
                  SingleChildScrollView(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.stretch,
                        children: [
                          Text('Crie seu acesso', style: AppTextStyles.headline),
                          const SizedBox(height: 8),
                          Text(
                          ...
                          AppInput(
                            ...
                            textInputAction: TextInputAction.next,
                            validator: (v) {
                              if (v!.isEmpty) return AppStrings.campoObrigatorio;
                          ...
                          AppInput(
                            ...
                            obscureText: true,
                            textInputAction: TextInputAction.next,
                            validator: (v) => v!.length < 6 ? AppStrings.senhaMinimo6 : null,
                          ),
                          const SizedBox(height: AppDimens.lg),
                          AppInput(
                            ...
                            validator: (v) {
                              if (v!.isEmpty) return AppStrings.campoObrigatorio;
                              if (v != senhaController.text) return AppStrings.senhasNaoCoincidem;
                              return null;
                            },
                          ),
                          const SizedBox(height: AppDimens.section),
